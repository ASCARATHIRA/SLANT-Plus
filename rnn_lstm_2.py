...
batch_len = 1000
n_batches = int(math.ceil(float(batch_size) / batch_len))
num_classes = 2
state_size = N
learning_rate = 0.1
...
O = tf.placeholder(tf.float32, [None], name='sentiments')
...
with tf.variable_scope('rnn',reuse=None):
    t_w9 = tf.get_variable('t_w9', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_w10 = tf.get_variable('t_w10', [state_size], initializer=tf.random_uniform_initializer(0.1,1.0))
    t_w11 = tf.get_variable('t_w11', [state_size], initializer=tf.random_uniform_initializer(0.1, .1))
    t_i_w1 = tf.get_variable('t_i_w1', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_i_w2 = tf.get_variable('t_i_w2', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_i_w3 = tf.get_variable('t_i_w3', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_i_w4 = tf.get_variable('t_i_w4', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_i_w5 = tf.get_variable('t_i_w5', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_i_w6 = tf.get_variable('t_i_w6', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_i_w7 = tf.get_variable('t_i_w7', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_i_w8 = tf.get_variable('t_i_w8', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_i_W= tf.get_variable('t_i_W', [state_size, state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_o_w1 = tf.get_variable('t_o_w1', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_o_w2 = tf.get_variable('t_o_w2', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_o_w3 = tf.get_variable('t_o_w3', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_o_w4 = tf.get_variable('t_o_w4', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_o_w5 = tf.get_variable('t_o_w5', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_o_w6 = tf.get_variable('t_o_w6', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_o_w7 = tf.get_variable('t_o_w7', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_o_w8 = tf.get_variable('t_o_w8', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_o_W= tf.get_variable('t_o_W', [state_size, state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_f_w1 = tf.get_variable('t_f_w1', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_f_w2 = tf.get_variable('t_f_w2', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_f_w3 = tf.get_variable('t_f_w3', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_f_w4 = tf.get_variable('t_f_w4', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_f_w5 = tf.get_variable('t_f_w5', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_f_w6 = tf.get_variable('t_f_w6', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_f_w7 = tf.get_variable('t_f_w7', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_f_w8 = tf.get_variable('t_f_w8', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_f_W= tf.get_variable('t_f_W', [state_size, state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_c_w1 = tf.get_variable('t_c_w1', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_c_w2 = tf.get_variable('t_c_w2', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_c_w3 = tf.get_variable('t_c_w3', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_c_w4 = tf.get_variable('t_c_w4', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_c_w5 = tf.get_variable('t_c_w5', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_c_w6 = tf.get_variable('t_c_w6', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_c_w7 = tf.get_variable('t_c_w7', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_c_w8 = tf.get_variable('t_c_w8', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_c_W= tf.get_variable('t_c_W', [state_size, state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
  
with tf.variable_scope('rnn_op',reuse=None):
    t_x_w9 = tf.get_variable('t_x_w9', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_x_w11 = tf.get_variable('t_x_w11', [state_size], initializer=tf.random_uniform_initializer(0.1, .1))
    t_xi_w1 = tf.get_variable('t_xi_w1', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_xi_w2 = tf.get_variable('t_xi_w2', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_xi_w3 = tf.get_variable('t_xi_w3', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_xi_w4 = tf.get_variable('t_xi_w4', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_xi_w5 = tf.get_variable('t_xi_w5', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_xi_w6 = tf.get_variable('t_xi_w6', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_xi_w7 = tf.get_variable('t_xi_w7', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_xi_w8 = tf.get_variable('t_xi_w8', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_xi_W= tf.get_variable('t_xi_W', [state_size, state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_xo_w1 = tf.get_variable('t_xo_w1', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_xo_w2 = tf.get_variable('t_xo_w2', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_xo_w3 = tf.get_variable('t_xo_w3', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_xo_w4 = tf.get_variable('t_xo_w4', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_xo_w5 = tf.get_variable('t_xo_w5', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_xo_w6 = tf.get_variable('t_xo_w6', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_xo_w7 = tf.get_variable('t_xo_w7', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_xo_w8 = tf.get_variable('t_xo_w8', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_xo_W= tf.get_variable('t_xo_W', [state_size, state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_xf_w1 = tf.get_variable('t_xf_w1', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_xf_w2 = tf.get_variable('t_xf_w2', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_xf_w3 = tf.get_variable('t_xf_w3', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_xf_w4 = tf.get_variable('t_xf_w4', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_xf_w5 = tf.get_variable('t_xf_w5', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_xf_w6 = tf.get_variable('t_xf_w6', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_xf_w7 = tf.get_variable('t_xf_w7', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_xf_w8 = tf.get_variable('t_xf_w8', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_xf_W= tf.get_variable('t_xf_W', [state_size, state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_xc_w1 = tf.get_variable('t_xc_w1', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_xc_w2 = tf.get_variable('t_xc_w2', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_xc_w3 = tf.get_variable('t_xc_w3', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_xc_w4 = tf.get_variable('t_xc_w4', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_xc_w5 = tf.get_variable('t_xc_w5', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_xc_w6 = tf.get_variable('t_xc_w6', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_xc_w7 = tf.get_variable('t_xc_w7', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_xc_w8 = tf.get_variable('t_xc_w8', [state_size], initializer=tf.random_uniform_initializer(0.0,1.0))
    t_xc_W= tf.get_variable('t_xc_W', [state_size, state_size], initializer=tf.random_uniform_initializer(0.0,1.0))  
...
def rnn_cell(u,t,m,state,c_state,state_x,c_state_x): 
    with tf.variable_scope('rnn',reuse=True):
        ...
        inp_gate = tf.sigmoid(t_i_w1 * tf.exp(-t_i_w2 * t) * state + tf.matmul([u], t_i_W)[0,:] * tf.matmul([u], ADJ)[0,:] * (t_i_w3 * tf.sigmoid(t_i_w4 * (m - t_i_w5)) - t_i_w6 * tf.sigmoid(-t_i_w7 * (m - t_i_w8))))
         
        for_gate = tf.sigmoid(t_f_w1 * tf.exp(-t_f_w2 * t) * state + tf.matmul([u], t_f_W)[0,:] * tf.matmul([u], ADJ)[0,:] * (t_f_w3 * tf.sigmoid(t_f_w4 * (m - t_f_w5)) - t_f_w6 * tf.sigmoid(-t_f_w7 * (m - t_f_w8))))

        out_gate = tf.sigmoid(t_o_w1 * tf.exp(-t_o_w2 * t) * state + tf.matmul([u], t_o_W)[0,:] * tf.matmul([u], ADJ)[0,:] * (t_o_w3 * tf.sigmoid(t_o_w4 * (m - t_o_w5)) - t_o_w6 * tf.sigmoid(-t_o_w7 * (m - t_o_w8))))

        new_mem = tf.tanh(t_c_w1 * tf.exp(-t_c_w2 * t) * state + tf.matmul([u], t_c_W)[0,:] * tf.matmul([u], ADJ)[0,:] * (t_c_w3 * tf.sigmoid(t_c_w4 * (m - t_c_w5)) - t_c_w6 * tf.sigmoid(-t_c_w7 * (m - t_c_w8))))
  
        c = (for_gate*c_state) + (inp_gate*new_mem)
        h = out_gate*tf.tanh(c)
        lamb = tf.exp(t_w9 + t_w10 * t + t_w11 * h)
    ...
    with tf.variable_scope('rnn_op',reuse=True):
        ...
        inp_gate = tf.sigmoid(t_xi_w1 * tf.exp(-t_xi_w2 * t) * state + tf.matmul([u], t_xi_W)[0,:] * tf.matmul([u], ADJ)[0,:] * (t_xi_w3 * tf.sigmoid(t_xi_w4 * (m - t_xi_w5)) - t_xi_w6 * tf.sigmoid(-t_xi_w7 * (m - t_xi_w8))))
         
        for_gate = tf.sigmoid(t_xf_w1 * tf.exp(-t_xf_w2 * t) * state + tf.matmul([u], t_xf_W)[0,:] * tf.matmul([u], ADJ)[0,:] * (t_xf_w3 * tf.sigmoid(t_xf_w4 * (m - t_xf_w5)) - t_xf_w6 * tf.sigmoid(-t_xf_w7 * (m - t_xf_w8))))

        out_gate = tf.sigmoid(t_xo_w1 * tf.exp(-t_xo_w2 * t) * state + tf.matmul([u], t_xo_W)[0,:] * tf.matmul([u], ADJ)[0,:] * (t_xo_w3 * tf.sigmoid(t_xo_w4 * (m - t_xo_w5)) - t_xo_w6 * tf.sigmoid(-t_xo_w7 * (m - t_xo_w8))))

        new_mem = tf.tanh(t_xc_w1 * tf.exp(-t_xc_w2 * t) * state + tf.matmul([u], t_xc_W)[0,:] * tf.matmul([u], ADJ)[0,:] * (t_xc_w3 * tf.sigmoid(t_xc_w4 * (m - t_xc_w5)) - t_xc_w6 * tf.sigmoid(-t_xc_w7 * (m - t_xc_w8))))
     
        c_x = (for_gate*c_state_x) + (inp_gate*new_mem)
        h_x = out_gate*tf.tanh(c_x)
        x = tf.tanh(t_x_w9 + t_x_w11 * h_x)
...
def get_integral(lamb_states):
    ...
    with tf.variable_scope('rnn', reuse=True):
        ...
        for i in range(batch_size-1):
            ret += tf.reduce_sum((tf.exp(t_w9+t_w10*tf.gather(T,i+1)+t_w11*lamb_states[i]) - tf.exp(t_w9+t_w11*lamb_states[i]))/t_w10)
    return ret
...
def train_network(num_epochs,state_size=N, verbose=True):
    with tf.Session() as sess:
        import os
        if not os.path.isdir(folder+'logs_lstm2'+str(N)):
            os.mkdir(folder+'logs_lstm2'+str(N))
        train_writer = tf.train.SummaryWriter(folder+'logs_lstm2'+str(N), sess.graph)
        sess.run(tf.initialize_all_variables())
        training_losses = []
        if os.path.isfile(folder+"model_lstm2"+str(N)+".ckpt"):
            training_state = np.zeros((state_size))
            saver.restore(sess, folder+"model_lstm2"+str(N)+".ckpt")
            T_w9, T_w10,T_w11= sess.run(
                [t_w9,t_w10,t_w11])
            T_i_w1,T_i_w2,T_i_w3,T_i_w4,T_i_w5,T_i_w6,T_i_w7,T_i_w8,T_i_W= sess.run(
                [t_i_w1,t_i_w2,t_i_w3,t_i_w4,t_i_w5,t_i_w6,t_i_w7,t_i_w8,t_i_W])
            T_f_w1,T_f_w2,T_f_w3,T_f_w4,T_f_w5,T_f_w6,T_f_w7,T_f_w8,T_f_W= sess.run(
                [t_f_w1,t_f_w2,t_f_w3,t_f_w4,t_f_w5,t_f_w6,t_f_w7,t_f_w8,t_f_W])
            T_o_w1,T_o_w2,T_o_w3,T_o_w4,T_o_w5,T_o_w6,T_o_w7,T_o_w8,T_o_W = sess.run(
                [t_o_w1,t_o_w2,t_o_w3,t_o_w4,t_o_w5,t_o_w6,t_o_w7,t_o_w8,t_o_W])
            T_c_w1,T_c_w2,T_c_w3,T_c_w4,T_c_w5,T_c_w6,T_c_w7,T_c_w8,T_c_W = sess.run(
                [t_c_w1,t_c_w2,t_c_w3,t_c_w4,t_c_w5,t_c_w6,t_c_w7,t_c_w8,t_c_W])
            T_x_w9,T_x_w11= sess.run(
                [t_x_w9,t_x_w11])
            T_xi_w1,T_xi_w2,T_xi_w3,T_xi_w4,T_xi_w5,T_xi_w6,T_xi_w7,T_xi_w8,T_xi_W= sess.run(
                [t_xi_w1,t_xi_w2,t_xi_w3,t_xi_w4,t_xi_w5,t_xi_w6,t_xi_w7,t_xi_w8,t_xi_W])
            T_xf_w1,T_xf_w2,T_xf_w3,T_xf_w4,T_xf_w5,T_xf_w6,T_xf_w7,T_xf_w8,T_xf_W= sess.run(
                [t_xf_w1,t_xf_w2,t_xf_w3,t_xf_w4,t_xf_w5,t_xf_w6,t_xf_w7,t_xf_w8,t_xf_W])
            T_xo_w1,T_xo_w2,T_xo_w3,T_xo_w4,T_xo_w5,T_xo_w6,T_xo_w7,T_xo_w8,T_xo_W = sess.run(
                [t_xo_w1,t_xo_w2,t_xo_w3,t_xo_w4,t_xo_w5,t_xo_w6,t_xo_w7,t_xo_w8,t_xo_W])
            T_xc_w1,T_xc_w2,T_xc_w3,T_xc_w4,T_xc_w5,T_xc_w6,T_xc_w7,T_xc_w8,T_xc_W = sess.run(
                [t_xc_w1,t_xc_w2,t_xc_w3,t_xc_w4,t_xc_w5,t_xc_w6,t_xc_w7,t_xc_w8,t_xc_W])
        else:
            epoch = 0
            ...
            while epoch < num_epochs:
                ...
                if verbose:
                    for b in range(n_batches):
                        ...
                        summary,training_loss_, _ = sess.run([merged,total_loss,train_step],feed_dict={U:_user,T:_dt,M:_dm,init_state:training_state,O:_X,ADJ:adj})
            ...
            T_xc_w1,T_xc_w2,T_xc_w3,T_xc_w4,T_xc_w5,T_xc_w6,T_xc_w7,T_xc_w8,T_xc_W = sess.run(
                [t_xc_w1,t_xc_w2,t_xc_w3,t_xc_w4,t_xc_w5,t_xc_w6,t_xc_w7,t_xc_w8,t_xc_W])
            saver.save(sess, folder+ "model_lstm2"+str(N)+".ckpt")
    return T_w9, T_w10, T_w11, T_i_w1, T_i_w2, T_i_w3, T_i_w4, T_i_w5, T_i_w6, T_i_w7, T_i_w8, T_i_W, T_o_w1, T_o_w2, T_o_w3, T_o_w4, T_o_w5, T_o_w6, T_o_w7, T_o_w8, T_o_W, T_f_w1, T_f_w2, T_f_w3, T_f_w4, T_f_w5, T_f_w6, T_f_w7, T_f_w8, T_f_W, T_c_w1, T_c_w2, T_c_w3, T_c_w4, T_c_w5, T_c_w6, T_c_w7, T_c_w8, T_c_W, T_x_w9, T_x_w11, T_xi_w1, T_xi_w2, T_xi_w3, T_xi_w4, T_xi_w5, T_xi_w6, T_xi_w7, T_xi_w8, T_xi_W, T_xo_w1, T_xo_w2, T_xo_w3, T_xo_w4, T_xo_w5, T_xo_w6, T_xo_w7, T_xo_w8, T_xo_W, T_xf_w1, T_xf_w2, T_xf_w3, T_xf_w4, T_xf_w5, T_xf_w6, T_xf_w7, T_xf_w8, T_xf_W,  T_xc_w1, T_xc_w2, T_xc_w3, T_xc_w4, T_xc_w5, T_xc_w6, T_xc_w7, T_xc_w8, T_xc_W

T_w9, T_w10, T_w11, T_i_w1, T_i_w2, T_i_w3, T_i_w4, T_i_w5, T_i_w6, T_i_w7, T_i_w8, T_i_W, T_o_w1, T_o_w2, T_o_w3, T_o_w4, T_o_w5, T_o_w6, T_o_w7, T_o_w8, T_o_W, T_f_w1, T_f_w2, T_f_w3, T_f_w4, T_f_w5, T_f_w6, T_f_w7, T_f_w8, T_f_W, T_c_w1, T_c_w2, T_c_w3, T_c_w4, T_c_w5, T_c_w6, T_c_w7, T_c_w8, T_c_W, T_x_w9, T_x_w11, T_xi_w1, T_xi_w2, T_xi_w3, T_xi_w4, T_xi_w5, T_xi_w6, T_xi_w7, T_xi_w8, T_xi_W, T_xo_w1, T_xo_w2, T_xo_w3, T_xo_w4, T_xo_w5, T_xo_w6, T_xo_w7, T_xo_w8, T_xo_W, T_xf_w1, T_xf_w2, T_xf_w3, T_xf_w4, T_xf_w5, T_xf_w6, T_xf_w7, T_xf_w8, T_xf_W,  T_xc_w1, T_xc_w2, T_xc_w3, T_xc_w4, T_xc_w5, T_xc_w6, T_xc_w7, T_xc_w8, T_xc_W = train_network(2000)
end_time = time.time()
