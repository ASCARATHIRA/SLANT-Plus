...
def train_network(num_epochs,state_size=N, verbose=True):
    with tf.Session() as sess:
        ...
        training_losses = []
        if os.path.isfile(folder+"model_3_"+str(t_s)+"_stacked"+str(N)+".ckpt"):
            saver.restore(sess, folder+"model_3_"+str(t_s)+"_stacked"+str(N)+".ckpt")
            ...
            saver.save(sess, folder+"model_3_"+str(t_s)+"_stacked"+str(N)+".ckpt")
